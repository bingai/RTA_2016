...
int estimateRigidTransformSIFT3DTo3DRANSAC(const Eigen::MatrixXf &frame_loc, const std::vector<float> &frame_descr, const Eigen::MatrixXf &model_loc, const std::vector<float> &model_descr, SIFTEngine *sift_engine, Eigen::Matrix3f& R, Eigen::Vector3f& t, int iter, float dist_thresh, int min_inlier_count) {
...
int estimateRigidTransformSIFT3DTo3DRANSAC(const Eigen::MatrixXf &frame_loc, const std::vector<float> &frame_descr, const Eigen::MatrixXf &model_loc, const std::vector<float> &model_descr, SIFTEngine *sift_engine, Eigen::Matrix4f& tform, int iter, float dist_thresh, int min_inlier_count) {
	Eigen::Matrix3f R;
	Eigen::Vector3f t;
	int success = estimateRigidTransformSIFT3DTo3DRANSAC(frame_loc, frame_descr, model_loc, model_descr, sift_engine, R, t, iter, dist_thresh, min_inlier_count);
	tform = homogeneousTransformationMatrixFromRt(R,t);
	return success;
}

int estimateRigidTransformSIFT2DTo3DRANSAC(const Eigen::MatrixXf &frame_loc, const std::vector<float> &frame_descr, const Eigen::MatrixXf &model_loc, const std::vector<float> &model_descr, const cv::Mat &K, const cv::Mat &d, SIFTEngine *sift_engine, Eigen::Matrix3f& R, Eigen::Vector3f& t, int iter, float dist_thresh, int min_inlier_count) {
...
int estimateRigidTransformSIFT2DTo3DRANSAC(const Eigen::MatrixXf &frame_loc, const std::vector<float> &frame_descr, const Eigen::MatrixXf &model_loc, const std::vector<float> &model_descr, const cv::Mat &K, const cv::Mat &d, SIFTEngine *sift_engine, Eigen::Matrix4f& tform, int iter, float dist_thresh, int min_inlier_count) {
	Eigen::Matrix3f R;
	Eigen::Vector3f t;
	int success = estimateRigidTransformSIFT2DTo3DRANSAC(frame_loc, frame_descr, model_loc, model_descr, K, d, sift_engine, R, t, iter, dist_thresh, min_inlier_count);
	tform = homogeneousTransformationMatrixFromRt(R,t);
	return success;
}
